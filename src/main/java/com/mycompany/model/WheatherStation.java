...
public class WheatherStation {
    /**
     *id - it's a unique number of station
     */
    private int id;
    /**
     * town - it's a place where this station is located
     */
    private String town;
    /**
     * measurement - it's an object with all parameters which this station measure
     */
    private Measurement measurement;

    /**
     * It is a class constructor
     * @param town - it's a place where this station is located. Town is given to constructor when this object is created
     * @param measurement - measurement which this station has. It is given when station is created
     */
 ...
 * 
 * @param measurement is an object which has all parameters measure for this station
 */
