...
public class WheatherStation {
    ...
    private String town;
    /**
     * It's an object with all parameters which this station
     * measure
     */
     ...
     * Class constructor
     *
     * @param town  it's a place where this station is located. Town is given
     * to constructor when this object is created
